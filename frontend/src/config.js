...
const EC2_API_URL = 'https://api.klipsmart.shop';
...
export const PYTHON_API =  USE_EC2_SERVER ?  "https://py.klipsmart.shop" :  "http://127.0.0.1:4001/" ;


const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'https://py.klipsmart.shop/api';
