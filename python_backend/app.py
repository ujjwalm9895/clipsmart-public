...
def get_transcript(video_id):
    try:
        ...
        # Languages priority: English, then Hindi, then any
        ...
        # If still None, try without language restriction (any available transcript)
        if not transcript_list:
            try:
                transcript_list = ytt_api.fetch(video_id)
                used_language = "auto_detected"
